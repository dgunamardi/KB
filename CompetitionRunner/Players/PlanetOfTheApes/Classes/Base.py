...
def neighbors(c):
    ...
    return [c-1, c+1, c-conf.W, c+conf.W]

def diag_neighbors(c):
    """ generator of coordinates for all diagonal neighbors of c """
    return [c-conf.W-1, c-conf.W+1, c+conf.W-1, c+conf.W+1]
...
def empty_position():
    ...
    return Position(board=conf.empty, cap=(0, 0), n=0, ko=None, last=None, last2=None, komi=7.5)