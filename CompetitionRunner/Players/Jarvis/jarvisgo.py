...
PROB_RSAREJECT = 0.5
RESIGN_THRES = 0.2
FASTPLAY20_THRES = 0.7
FASTPLAY5_THRES = 0.9
FASTPLAY30_THRES = 0.6
...
def tree_search(tree, n, owner_map, disp=False):
    ...
    while i < n:
        ...
        if i > n * 0.05 and best_wr > FASTPLAY5_THRES or i > n * 0.2 and best_wr > FASTPLAY20_THRES or i > n * 0.3 and best_wr > FASTPLAY30_THRES:
            break
